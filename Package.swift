...
let package = Package(
    ...
    products: [
        .library(
            name: "CapacitorCommunityImageToText",
            targets: ["CapacitorOcrPlugin"])
    ],
    dependencies: [capacitor],
    targets: [
        .target(
            name: "CapacitorOcrPlugin",
            dependencies: [
                .product(name: "Capacitor", package: "capacitor-swift-pm")
            ],
            path: "ios/Sources/CapacitorOcrPlugin"),
        .testTarget(
            name: "CapacitorOcrPluginTests",
            dependencies: ["CapacitorOcrPlugin"],
            path: "ios/Tests/CapacitorOcrPluginTests")
    ]
)
